...
class HTTPServer:
            ...
            while True:
                ...
                if pid == 0:
                    with conn:
                        ...
                        uri = client_request.split()[1]
                        code, c_type, c_length, data = self.get_data(uri)
                        temp = (code, c_type, c_length, data)
                        print("keys before updating cache",self.cache.keys())
                        if (len(self.cache) == self.Cache_size):
                                ...
                                if uri in self.cache:
                                        ...
                                        self.cache[uri] = temp
                        print("keys after updating cache",self.cache.keys())
    ...
    def get_data(self, uri):
        ...
        print("End of the get_data")
        data = "<h1> File Not Found got here</h1>"
        return (200, "text/html", len(data), data.encode("utf-8"))
